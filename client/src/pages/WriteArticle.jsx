...
const WriteArticle = () => {
  ...
  return (
    <div className="h-full overflow-y-auto p-6 flex flex-col lg:flex-row gap-6 text-slate-700">
        ...
        <div className="mt-3 flex gap-3 flex-wrap sm:max-w-9/11">
          {articleLength.map((item, index) => (
            <span
              ...
              className={`text-xs px-5 py-2 font-medium rounded-full cursor-pointer transition-all duration-300 transform ${
                selectedLength.text === item.text
                  ? 'bg-primary text-white shadow-md scale-105 border-blue-600'
      ...
      <div className="w-full lg:w-1/2 max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 max-h-[600px] overflow-y-auto">
        <div className="flex items-center gap-3">
